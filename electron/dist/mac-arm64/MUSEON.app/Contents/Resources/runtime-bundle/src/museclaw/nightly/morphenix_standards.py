...
# ═══════════════════════════════════════════
# 這些原則定義 MuseClaw 作為 AI 的根本行為邊界，
# 任何模組（包括 Brain、Skills、Workflow）都不能違反。
# MuseClaw 正常的 ANIMA 寫入（觀察引擎更新 ANIMA_MC/USER）不受影響，
...
L2_ALLOWED_PATTERNS = L1_ALLOWED_PATTERNS + [
    r"src/museclaw/agent/skills\.py$",
    r"src/museclaw/nightly/.*\.py$",
    r"src/museclaw/workflow/.*\.py$",
    r"src/museclaw/memory/.*\.py$",
    r"src/museclaw/tools/.*\.py$",
]
