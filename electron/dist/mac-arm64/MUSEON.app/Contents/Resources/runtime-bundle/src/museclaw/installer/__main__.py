...
用法: python -m museclaw.installer [--non-interactive] [--verbose]
"""
...
def find_install_dir() -> Path:
    ...
    優先用環境變數 MUSECLAW_HOME，否則用 __file__ 反推。
    ...
    env_home = os.environ.get("MUSECLAW_HOME")
    if env_home:
