...
class InstallerOrchestrator:
    ...
    def check_day0_readiness(self) -> str:
        ...
        if daemon_ok:
            lines.append("🎉 MuseClaw Gateway 24/7 運行中！")
            lines.append("")
            ...
            lines.append("")
            lines.append("   打開 Telegram → 找到你的 MuseClaw Bot → 說第一句話")
            lines.append("")
    ...
    def _step_tools(self) -> StepResult:
        """Step 7b: 安裝所有 MuseClaw AI 工具（Docker/Native）.
        ...
        try:
            from museclaw.tools.tool_registry import ToolRegistry, INSTALL_ORDER
