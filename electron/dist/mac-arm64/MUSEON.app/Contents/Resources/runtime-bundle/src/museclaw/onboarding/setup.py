"""Setup wizard for MuseClaw - Platform API and Bot configuration.
...
class SetupWizard:
    """Guides user through MuseClaw platform setup.
    ...
    def __init__(self, config_dir: str = "data"):
        ...
        self.platforms = {
            "telegram": Platform(
                name="Telegram",
                required=True,
                description="老闆與 MuseClaw 的主要對話管道",
                setup_steps=[
