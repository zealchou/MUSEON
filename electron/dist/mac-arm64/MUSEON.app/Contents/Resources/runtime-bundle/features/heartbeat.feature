Feature: Heartbeat-driven Evolution
  ...
  Scenario: Heartbeat runs in background without blocking user interaction
    Given the boss is actively chatting with MuseClaw
