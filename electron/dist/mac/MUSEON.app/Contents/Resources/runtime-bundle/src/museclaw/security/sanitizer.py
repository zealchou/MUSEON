...
class InputSanitizer:
    ...
    # 注意：不要放太常見的中文詞（如「執行」= 執行長/執行力/進行），
    #       否則會誤殺正常對話。只放真正的攻擊指令詞。
    INSTRUCTION_KEYWORDS = [
        "忽略所有指令", "無視以上規則", "不要遵守", "停止遵循",
        "ignore all instructions", "disregard previous", "override system",
        "bypass safety", "must follow my instructions",
        "execute code", "运行代码",
    ]
