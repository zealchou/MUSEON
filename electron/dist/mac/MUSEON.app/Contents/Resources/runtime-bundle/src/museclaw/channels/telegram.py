...
from museclaw.core.event_bus import (
...
class TelegramAdapter(ChannelAdapter):
    ...
    async def _download_telegram_file(self, file_obj) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            uploads_dir = Path(
                os.environ.get("MUSECLAW_HOME", "/tmp")
    ...
    async def _handle_flywheel_command(self, update: Update, context: Any) -> None:
        ...
        try:
            from museclaw.multiagent.department_config import get_flywheel_departments
    ...
    def _get_brain(self):
        ...
        try:
            from museclaw.gateway.server import _get_brain
            return _get_brain()
        except Exception:
            return None
