...
| `test_integration.py` | `agent-sdk/test_integration.py` | HTTP 整合測試（33 場景） |
...
| `AGENT_ONBOARDING_STEPS.md` | Admin 手動對接操作手冊 |
