...
SELF_REPAIR_EXECUTED = "SELF_REPAIR_EXECUTED"                # DEPRECATED(v1.42): 無發布/訂閱者
...
# ═══════════════════════════════════════════
TOKEN_BUDGET_WARNING = "TOKEN_BUDGET_WARNING"                # DEPRECATED(v1.42): 無發布/訂閱者
TOKEN_BUDGET_CONSERVATION = "TOKEN_BUDGET_CONSERVATION"      # DEPRECATED(v1.42): 無發布/訂閱者
...
EVOLUTION_TRACE = "EVOLUTION_TRACE"                          # DEPRECATED(v1.42): 無發布/訂閱者
...
REFRACTORY_WAKE = "REFRACTORY_WAKE"                          # DEPRECATED(v1.42): 無發布/訂閱者
GATEWAY_DEGRADED = "GATEWAY_DEGRADED"                        # DEPRECATED(v1.42): 無發布/訂閱者
...
# NOTE: HEALTH_SCORE_UPDATED 已在 L110 定義（Dendritic Layer），此處不重複定義
